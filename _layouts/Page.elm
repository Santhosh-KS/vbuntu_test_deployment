...
header =
    [ div [ class "header-logo" ]
        [ img [ alt "Author's blog", src "/img/VbuntuTransparentLogo.png", attribute "width" "250" ]
            []
        ]
...
footer =
    div [ class "footer" ]
        [ img
            [ alt "Vbuntu logo"
            , src "/img/VbuntuTransparentLogo.png"
        ...
        , div [ class "link" ]
            [ githubIcon
            , a [ href "https://github.com/webuntyou/webuntyou" ]
                [ text "vbuntu Github" ]
            ]
        , div [ class "link" ]
