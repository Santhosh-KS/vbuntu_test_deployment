...
styles =
    let
        ...
        codeStyle =
            [ fontFamilies [ "Ubuntu", "Inconsolata", .value monospace ]
            ]
    in
    global
        [ body
            ...
            , fontFamilies [ "Ubuntu", "Open Sans", "Arial", .value sansSerif ]
            , fontSize <| px 18
        ...
        , each [ h1, h2, h3, h4, h5, h6 ]
            [ fontFamilies [ "Ubuntu","Proza Libre", "Helvetica", .value sansSerif ]
